...
- `ohoimager/desklink-api:1.4.9-session-merge-v8`：包含 Go API、React 管理端与 Web Client。
...
| `DESKLINK_API_IMAGE` | `ohoimager/desklink-api:1.4.9-session-merge-v8` | API/管理端镜像 |
